 ...
 *
 */
public class SimBooleanData extends SimData{

	private double probabilityofTrue ;
	
	public SimBooleanData(String name, double probabilityofTrue){
	  super(name, null);
	  this.probabilityofTrue = probabilityofTrue;
	}
	
	public SimBooleanData(String name,String expression){
